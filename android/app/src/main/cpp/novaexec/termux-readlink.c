// Nova modification notice (Apache-2.0 §4b):
// Forked from termux-play-store/termux-exec v1.9 (Apache-2.0; see LICENSE.UPSTREAM)
// for the Nova IDE (package sd.adaa.codeide). No functional Nova changes yet;
// the /proc/self/exe interception behavior is validated as-is on device.
