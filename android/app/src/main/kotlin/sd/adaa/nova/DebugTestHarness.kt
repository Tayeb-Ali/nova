 ...
 * Trigger via: adb shell am broadcast -a sd.adaa.nova.DEBUG_COMPREHENSIVE_TEST -n sd.adaa.nova/.MainActivity
            ...
            try {
                ...
                try {
                    ...
                    File(prefix, "etc/apt/apt.conf").takeIf { it.exists() }?.let {
                        ...
                        else if (it.readText().contains("/data/user/0/sd.adaa.nova")) {
